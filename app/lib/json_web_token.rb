...
class JsonWebToken
  ...
  PROJECT_ID = 'application-e3eb0'
  ISSUER_URI_BASE = "https://securetoken.google.com/application-e3eb0"
  ...
  def self.verify(token)
    ...
    raise "Invalid Auth Tile" unless Time.zone.at(payload['auth_time']).past?
